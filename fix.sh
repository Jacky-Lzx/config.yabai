...
## Reference: `https://github.com/asmvik/yabai/issues/2686#issuecomment-3678216885`

## This fix script fixes the scripting-addition.
## After running the script with sudo, you need to run `sudo yabai --load-sa` again
